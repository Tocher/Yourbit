 ...
 */
angular.module('angularFileUpload').factory('$fileUploader', ['$compile', '$rootScope', '$http', '$window', function($compile, $rootScope, $http, $window) {
    'use strict';
    ...
    Uploader.prototype = {
        ...
        /**
         * Returns items ready for uploads
         * @returns {Array}
         */
        ...
        /**
         * Checks whether uploads successful
         * @param {Number} status
         * @returns {Boolean}
         * @private
         */
